...
public class Employee {
    ...
    private Employee(String name, int age, String gender, Address adress, 
            Department department, List<Phone> phones, List<Contact> contacs) {
        this.name = name;
        this.age = age;
        this.gender = gender;
        this.adress = adress;
    ...
    public static class EmployeeBuilder implements IBuilder<Employee>{
        ...
        public EmployeeBuilder setDeparmtent(String name) {
        ...
        public Employee build() {
            return new Employee(name, age, gender, adress, department, phones, contacs);
        }
    }
}